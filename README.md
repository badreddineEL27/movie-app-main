...
Movie Application using React JS, Typescript and Tailwind CSS, allows user to search and see the trailer of the movie using TMDB API.
...
- Run the following command to clone the project from GitHub:
  ```bash
  git clone https://github.com/badreddineEL27/movies-app.git
  ```
